...
$CC -O3 float2half.c hardware.o table.o table_round.o no_table.o imath.o -o float2half_aarch64
$CC -O3 half2float.c hardware.o table.o table_round.o no_table.o imath.o -o half2float_aarch64
...
$CC -O3 float2half.c hardware.o table.o table_round.o no_table.o imath.o -o float2half_arm
$CC -O3 half2float.c hardware.o table.o table_round.o no_table.o imath.o -o half2float_arm
...
$CC -O3 float2half.c hardware.o table.o table_round.o no_table.o imath.o -o float2half
$CC -O3 half2float.c hardware.o table.o table_round.o no_table.o imath.o -o half2float
