...
$CC -O3 -c x86_cpu_info.c
#debug sse2
# $CC -O3 -mtune=generic -msse2 -mf16c  -c maratyszcza_sse2/maratyszcza_sse2.c


$CC -O3 float2half.c x86_cpu_info.o hardware.o table.o table_round.o no_table.o imath.o cpython.o numpy.o tursa.o ryg.o maratyszcza.o maratyszcza_nanfix.o maratyszcza_sse2.o -o float2half
$CC -O3 half2float.c x86_cpu_info.o hardware.o table.o table_round.o no_table.o imath.o cpython.o numpy.o tursa.o ryg.o maratyszcza.o maratyszcza_nanfix.o maratyszcza_sse2.o -o half2float
