...
$CC -O3 src/float2half.c hardware.o table.o table_round.o no_table.o imath.o cpython.o numpy.o tursa.o ryg.o maratyszcza.o maratyszcza_nanfix.o -o float2half_aarch64
$CC -O3 src/half2float.c hardware.o table.o table_round.o no_table.o imath.o cpython.o numpy.o tursa.o ryg.o maratyszcza.o maratyszcza_nanfix.o -o half2float_aarch64
...
$CC -O3 src/float2half.c hardware.o table.o table_round.o no_table.o imath.o cpython.o numpy.o tursa.o ryg.o maratyszcza.o maratyszcza_nanfix.o -o float2half_arm
$CC -O3 src/half2float.c hardware.o table.o table_round.o no_table.o imath.o cpython.o numpy.o tursa.o ryg.o maratyszcza.o maratyszcza_nanfix.o -o half2float_arm
...
$CC -O3 src/float2half.c x86_cpu_info.o hardware.o table.o table_round.o no_table.o imath.o cpython.o numpy.o tursa.o ryg.o maratyszcza.o maratyszcza_nanfix.o maratyszcza_sse2.o -o float2half
$CC -O3 src/half2float.c x86_cpu_info.o hardware.o table.o table_round.o no_table.o imath.o cpython.o numpy.o tursa.o ryg.o maratyszcza.o maratyszcza_nanfix.o maratyszcza_sse2.o -o half2float
