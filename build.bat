...
cl /nologo float2half.c -O2 /link hardware.obj table.obj table_round.obj no_table.obj imath.obj numpy.obj tursa.obj || goto :error
cl /nologo half2float.c -O2 /link hardware.obj table.obj table_round.obj no_table.obj imath.obj numpy.obj tursa.obj || goto :error
